...
# =====================
# 5. ESTIMATE P-DYNAMICS OF x_t AND y_t
# =====================

x_params = estimate_ou_params(factors["x"], factors["DATE"])
y_params = estimate_ou_params(factors["y"], factors["DATE"])

a1_P = x_params["a"]
b1_P = x_params["b"]
sigma1_P = x_params["sigma"]

a2_P = y_params["a"]
b2_P = y_params["b"]
sigma2_P = y_params["sigma"]
...
print("P-measure factor parameters")
print("---------------------------")
print("a1_P =", a1_P)
print("b1_P =", b1_P * 100, "%")
print("sigma1_P =", sigma1_P * 100, "%")
print()
print("a2_P =", a2_P)
print("b2_P =", b2_P * 100, "%")
print("sigma2_P =", sigma2_P * 100, "%")
print()
print("rho_P =", rho_P)
print()
print("Long-run short rate under P =", (b1_P + b2_P) * 100, "%")
